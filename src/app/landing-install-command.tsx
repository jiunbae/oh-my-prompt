...
const INSTALL_CMD = "npm install -g oh-my-prompt && omp setup";
  ...
  return (
    <div className="mx-auto max-w-lg">
      <div className="flex items-center gap-2 rounded-lg border border-border bg-card px-4 py-3 font-mono text-sm">
        ...
        >
          {copied ? (
            <svg className="h-4 w-4 text-[var(--accent-gradient-from)]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
